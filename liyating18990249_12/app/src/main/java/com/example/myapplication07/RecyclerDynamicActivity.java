...
import com.example.myapplication07.adapter.LinearDynamicAdapter;
import com.example.myapplication07.bean.GoodsInfos;
import com.example.myapplication07.widget.RecyclerExtras.OnItemDeleteClickListener;
import com.example.myapplication07.widget.SpacesItemDecoration;
import com.example.myapplication07.widget.RecyclerExtras.OnItemClickListener;
import com.example.myapplication07.widget.RecyclerExtras.OnItemLongClickListener;
...
public class RecyclerDynamicActivity extends AppCompatActivity implements OnClickListener
    ...
    private ArrayList<GoodsInfos> mPublicArray; // 当前公众号信息队列
    private ArrayList<GoodsInfos> mAllArray; // 所有公众号信息队列
    ...
    private void initRecyclerDynamic() {
        ...
        // 获取默认的所有公众号信息队列
        mAllArray = GoodsInfos.getDefaultList();
        // 获取默认的当前公众号信息队列
        mPublicArray = GoodsInfos.getDefaultList();
        // 构建一个公众号列表的线性适配器
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_recycler_add) {
            ...
            GoodsInfos old_item = mAllArray.get(position);
            GoodsInfos new_item = new GoodsInfos(old_item.pic_id, old_item.title, old_item.desc);
    ...
    public void onItemLongClick(View view, int position) {
        GoodsInfos item = mPublicArray.get(position);
