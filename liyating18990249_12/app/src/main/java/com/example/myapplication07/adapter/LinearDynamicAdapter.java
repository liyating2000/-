package com.example.myapplication07.adapter;
...
public class LinearDynamicAdapter extends RecyclerView.Adapter<ViewHolder>
    ...
    private ArrayList<GoodsInfos> mPublicArray;

    public LinearDynamicAdapter(Context context, ArrayList<GoodsInfos> publicArray) {
        mContext = context;
