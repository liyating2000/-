...
import com.example.myapplication07.adapter.RecyclerLinearAdapter;
...
public class RecyclerLinearActivity extends AppCompatActivity {
    ...
    private void initRecyclerLinear() {
        ...
        // 构建一个公众号列表的线性适配器
        RecyclerLinearAdapter adapter = new RecyclerLinearAdapter(this, GoodsInfos.getDefaultList());
        // 设置线性列表的点击监听器
